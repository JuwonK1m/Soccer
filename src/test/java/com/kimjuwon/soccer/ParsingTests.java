...
public class ParsingTests {
    ...
    void premierLeagueTableParsingTest() throws Exception {
        Document document = Jsoup.connect(PREMIER_LEAGUE_TABLE_URL).get();
