...
public class RankingController {
    ...
    @ApiOperation(value = "유럽 축구 5대 리그의 팀 전체 순위 읽어오기", notes = "유럽 축구 5대 리그의 팀 전체 순위를 읽어옵니다.\n(leagueId)\n1: 프리미어리그\n2: 라리가\n3: 분데스리가\n4: 세리에 A\n5: 프랑스 리그 1")
    ...
    @ApiOperation(value = "유럽 축구 5대 리그의 특정 팀 순위 읽어오기", notes = "유럽 축구 5대 리그의 팀 전체 순위를 읽어옵니다.\n(leagueId)\n1: 프리미어리그\n2: 라리가\n3: 분데스리가\n4: 세리에 A\n5: 프랑스 리그 1\n(clubName)\n예시: 도르트문트")
    @GetMapping(value = "/league/{leagueId}/club/ranking")
